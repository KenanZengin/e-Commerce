  ...
  return (
    <div className='help_categories'>
        ...
        >
            ...
            <Tab eventKey="Seller/Shopper Support" title="Seller/Shopper Support" >
                <Accordion defaultActiveKey="4">
                    <Accordion.Item eventKey="4">
                        <Accordion.Header>I am a 3PL or other service provider and would love to offer my services to Rivly sellers. How can I do this?</Accordion.Header>
                        <Accordion.Body>
            ...
            <Tab eventKey="Fees, Taxes & Payments" title="Fees, Taxes & Payments" >
                <Accordion defaultActiveKey="4">
                    <Accordion.Item eventKey="4">
                        <Accordion.Header>I am a 3PL or other service provider and would love to offer my services to Rivly sellers. How can I do this?</Accordion.Header>
                        <Accordion.Body>
            ...
            <Tab eventKey="Affiliates & Investors" title="Affiliates & Investors" >
                <Accordion defaultActiveKey="4">
                    <Accordion.Item eventKey="4">
                        <Accordion.Header>I am a 3PL or other service provider and would love to offer my services to Rivly sellers. How can I do this?</Accordion.Header>
                        <Accordion.Body>
